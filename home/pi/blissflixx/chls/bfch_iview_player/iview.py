...
class IviewEpisodeNode(Node):
    ...
    def find_hls_url(self, playlist):
        for video in playlist:
            if video["type"] in ["livestream", "program"]:
