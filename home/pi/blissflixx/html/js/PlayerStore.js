function PlayerStore() {
  ...
  self.playOnDevice = function(url, title, cb) {
    Utils.rpc('playr', 'playOnDevice', {url: url, title: title}, cb)
  }

  self.playOnRB = function(url, title, cb) {
    Utils.rpc('playr', 'playOnRB', {url: url, title: title}, cb)
  }
