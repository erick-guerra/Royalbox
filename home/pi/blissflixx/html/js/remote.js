...
$(function() {
	...
	$( "#backward" ).click(function() {
		mkrequest("/video?control=minus30", 0);
	});
	
	$( "#forward" ).click(function() {
		mkrequest("/video?control=plus30", 0);
	});

	$( "#long-backward" ).click(function() {
		mkrequest("/video?control=minus600", 0);
	});
	
	$( "#long-forward" ).click(function() {
		mkrequest("/video?control=plus600", 0);
	});
	
	$( "#vol_down" ).click(function() {
		mkrequest("/video?control=voldown", 0);
	});
	
	$( "#vol_up" ).click(function() {
		mkrequest("/video?control=volup", 0);
	});
