...
import com.gplexdb.royalboxremote.R;
...
public class MainActivity extends Activity {
    ...
    final String notavailable = "<html><title>Oops...</title><body><h2>Oops...</h2><p>I couldn't access the server</p><p>Please make sure :<ul><li><b>The HOSTNAME of your Royalbox (Raspberry Pi) is correct</li><li>The Royalbox is running on your Raspberry Pi</li><li>You are on the same network as your Raspberry Pi</li><li>Try rebooting Royalbox.</li></b></ul></p></body></html>";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setIp(settings.getString(IPsettings,"royalbox.local"));
        ip = settings.getString(getIPsettings(), "royalbox.local");

        setUrl("http://" + getIp() + ":2020/remote.html");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.refresh:
                ...
                return true;
            case R.id.about:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/omody/Royalbox"));
